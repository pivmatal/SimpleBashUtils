...
cat -A  test1.txt test2.txt  > cat_test_results.txt 
./s21_cat -A test1.txt test2.txt > s21_cat_test_results.txt
diff cat_test_results.txt s21_cat_test_results.txt
if [ $? = 0 ]
...
cat --show-all  test1.txt test2.txt > cat_test_results.txt 
./s21_cat --show-all  test1.txt test2.txt  > s21_cat_test_results.txt
diff cat_test_results.txt s21_cat_test_results.txt
if [ $? = 0 ]
...
cat --show-nonprinting   test1.txt test2.txt > cat_test_results.txt 
./s21_cat --show-nonprinting  test1.txt test2.txt  > s21_cat_test_results.txt
diff cat_test_results.txt s21_cat_test_results.txt
if [ $? = 0 ]
...
cat --show-tabs   test1.txt test2.txt > cat_test_results.txt 
./s21_cat --show-tabs  test1.txt test2.txt  > s21_cat_test_results.txt
diff cat_test_results.txt s21_cat_test_results.txt
if [ $? = 0 ]
...
cat --squeeze-blank  test3.txt test2.txt > cat_test_results.txt 
./s21_cat --squeeze-blank  test3.txt test2.txt  > s21_cat_test_results.txt
diff cat_test_results.txt s21_cat_test_results.txt
if [ $? = 0 ]
...
cat --number  test3.txt test2.txt > cat_test_results.txt 
./s21_cat --number  test3.txt test2.txt  > s21_cat_test_results.txt
diff cat_test_results.txt s21_cat_test_results.txt
if [ $? = 0 ]
...
cat --show-ends  test3.txt test2.txt > cat_test_results.txt 
./s21_cat --show-ends  test3.txt test2.txt  > s21_cat_test_results.txt
diff cat_test_results.txt s21_cat_test_results.txt
if [ $? = 0 ]
...
cat --number-nonblank  test3.txt test2.txt > cat_test_results.txt 
./s21_cat --number-nonblank  test3.txt test2.txt  > s21_cat_test_results.txt
diff cat_test_results.txt s21_cat_test_results.txt
if [ $? = 0 ]
...
cat --number-nonblank --show-ends --number --squeeze-blank --show-tabs  --show-all --show-nonprinting -A -E -T -b -e -n -s -t -v  test3.txt test2.txt > cat_test_results.txt 
./s21_cat --number-nonblank --show-ends --number --squeeze-blank --show-tabs  --show-all --show-nonprinting -A -E -T -b -e -n -s -t -v test3.txt test2.txt > s21_cat_test_results.txt
diff cat_test_results.txt s21_cat_test_results.txt
if [ $? = 0 ]
